/**
 * Task Mapper — Phase 2 Centralized SAP Payload Transformation
 *
 * Converts raw SAP TASKPROCESSING OData responses into stable internal domain models.
 * All SAP-specific field names and data quirks are isolated here.
 *
 * Rules:
 *   - Pure mapping: deterministic, no side effects
 *   - No SAP calls
 *   - No route/controller dependencies
 *   - No business logic (no context resolution, no enrichment)
 *
 * Migrated from: srv/inbox/task-adapter.ts (Phase 2)
 */
